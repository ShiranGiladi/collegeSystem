    ...
    <Container className="settings mt-4">
      ...
      <div className="custom-container p-4">
        ...
        <div className="row mt-4">
          <div className="col">
            <Button className="btn-secondary" onClick={() => window.location.href = '/settings'}>Update Preferences</Button>
          </div>
        </div>
      </div>
      ...
      <div className="custom-container p-4 mt-4">
        ...
        <Container className="help-container">
          <form>
            ...
            <Button type="submit" className="btn-secondary submit-help">Submit</Button>
          </form>
        </Container>
      </div>
      <br />
